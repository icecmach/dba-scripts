...
/*col USER_NAME format a25
col ENABLED_OPTION format a10
col SUCCESS format a10
col FAILURE format a10
select USER_NAME,POLICY_NAME, ENABLED_OPTION,SUCCESS,FAILURE
...
col SYSTEM_PRIVILEGE_USED format a26
